...
// Запуск из исходников живёт в своём профиле. Иначе он не заведётся рядом
// с установленным плеером - замок ниже один на профиль, - а если бы завёлся,
// две копии делили бы один settings.json и затирали друг друга.
